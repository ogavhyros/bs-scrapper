// Inline LinkedIn glyph — lucide-react dropped brand icons, so we ship our own.
// API-compatible with lucide icons: accepts `size`, `className`, `style`.
export default function LinkedInIcon({ size = 18, className = '', style }) {
  return (
    <svg
      width={size}
      height={size}
